  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-8">
      ...
      <div className="space-y-4 text-text-secondary text-sm leading-relaxed">
        <p>By uploading an MP3, WAV, or other audio file to EVLightShows.com, you confirm that you own the file or have permission to use it for this purpose.</p>
        ...
        <p>EVLightShows.com does not claim ownership of your uploaded music. We use uploaded files only to generate the requested custom light show files and provide the service you ordered.</p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">Customers are responsible for making sure they have the right to upload and use any audio submitted to EVLightShows.com. Uploading a file does not transfer ownership of that audio to EVLightShows.com.</p>
      </section>
