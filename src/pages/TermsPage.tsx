...
export default function TermsPage({ onNavigate }: TermsPageProps) {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-8">
      ...
      <p className="text-text-secondary text-sm leading-relaxed">These Terms of Service govern your use of EVLightShows.com. By using this website, uploading a file, placing an order, or downloading generated files, you agree to these Terms.</p>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          ...
          <p>EVLightShows.com does not sell Tesla vehicles, Tesla products, Tesla parts, Tesla accessories, Tesla software, Tesla repair, or Tesla support services.</p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          <p>EVLightShows.com allows customers to upload audio files, such as MP3 or WAV files, and receive custom-generated digital light show files intended for compatible Tesla vehicles.</p>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          ...
          <p>You keep ownership of your uploaded content. By uploading content, you give EVLightShows.com permission to use that content only as needed to provide the requested service, generate light show files, process your order, provide support, and improve site functionality.</p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          <p>You may not use EVLightShows.com to upload, create, request, or distribute content that is unlawful, infringing, abusive, harmful, deceptive, obscene, or otherwise inappropriate.</p>
          <p>You may not use EVLightShows.com to impersonate Tesla, Inc., misrepresent affiliation with Tesla, or create content that falsely suggests endorsement, sponsorship, or approval by Tesla.</p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          <p>EVLightShows.com provides digital products. Delivery may occur through download links, customer account access, email, or another digital delivery method.</p>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          ...
          <p>If there is a technical issue with your order, contact support@evlightshows.com. We may offer a corrected file, replacement generation, store credit, or refund at our discretion.</p>
        </div>
      </section>

      <section className="space-y-3">
        <h2 className="text-lg font-display font-bold text-text-primary">10. No Tesla Account Access</h2>
        <p className="text-text-secondary text-sm leading-relaxed">EVLightShows.com does not require access to your Tesla account. Do not provide your Tesla login information, Tesla app credentials, or other sensitive account information through this website.</p>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          ...
          <p>EVLightShows.com is not responsible for tickets, violations, property complaints, vehicle issues, accidents, injuries, disturbances, or damages caused by your use of generated files.</p>
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          <p>The EVLightShows.com website, branding, generated non-customer materials, page content, graphics, and service structure are owned by EVLightShows.com or its operator, except for third-party trademarks and customer-uploaded content.</p>
      ...
      <section className="space-y-3">
        ...
        <div className="text-text-secondary text-sm leading-relaxed space-y-3">
          <p>EVLightShows.com is provided on an "as is" and "as available" basis. We do not guarantee uninterrupted service, error-free operation, perfect file compatibility, or specific results.</p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">To the fullest extent permitted by law, EVLightShows.com and its operator will not be liable for indirect, incidental, special, consequential, or punitive damages, including loss of data, loss of profits, vehicle issues, failed downloads, incompatible files, or customer setup errors.</p>
      </section>
