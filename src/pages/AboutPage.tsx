...
export default function AboutPage({ onNavigate }: AboutPageProps) {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 py-10 sm:py-14 space-y-8">
      <h1 className="text-2xl sm:text-3xl font-display font-bold text-text-primary">About TeslaLightShows.com</h1>

      <div className="space-y-4 text-text-secondary text-sm leading-relaxed">
        <p>TeslaLightShows.com is an independent digital service that creates custom light show files for Tesla vehicle owners who want a personalized music-based light show experience.</p>
        ...
        <p>TeslaLightShows.com is not Tesla, Inc. We are not affiliated with Tesla, sponsored by Tesla, endorsed by Tesla, or approved by Tesla. We are an independent service created for Tesla owners and enthusiasts who want custom light show files for personal entertainment use.</p>
      ...
      <section className="space-y-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">TeslaLightShows.com provides digital light show files generated from customer-uploaded music. Depending on the service selected, customers may receive one or more downloadable file options intended for compatible Tesla Light Show use.</p>
      </section>

      <section className="space-y-3">
        <h2 className="text-lg font-display font-bold text-text-primary">What We Do Not Provide</h2>
        <p className="text-text-secondary text-sm leading-relaxed">TeslaLightShows.com does not sell Tesla vehicles, Tesla parts, Tesla accessories, Tesla software, or Tesla repair services. We do not modify Tesla vehicles. We do not access your Tesla account. We do not guarantee that any light show will work on every vehicle, every software version, or every USB drive setup.</p>
      </section>

      <section className="space-y-3">
        <h2 className="text-lg font-display font-bold text-text-primary">Customer Responsibility</h2>
        <p className="text-text-secondary text-sm leading-relaxed">Customers are responsible for making sure they have the legal right to upload and use any audio file submitted to TeslaLightShows.com. Customers are also responsible for following USB formatting, folder structure, vehicle compatibility, and safe operation instructions for the Light Show feature.</p>
      </section>
