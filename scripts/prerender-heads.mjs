...
const routes = [
  ...
  ['best-tesla-light-show-software', 'Best Tesla Light Show Software | Generator vs xLights vs Downloads', 'Compare Tesla light show software options including EVLightShows.com, xLights, free download sites, and manual FSEQ creation. Find the best option for custom Tesla light shows.'],
  ...
  ['tesla-light-show-gallery', 'Tesla Light Show Gallery | Example Custom Shows', 'Watch examples of custom Tesla light shows created with EVLightShows.com, synced to real songs on Model 3, Model Y, Cybertruck, Model S, and Model X.'],
  ...
  ['pricing', 'Pricing — Custom Tesla Light Shows from $1.50 | EVLightShows.com', 'See pricing for custom Tesla light shows. Turn any song into a light show file for your Tesla. Free 20-second preview, credits from $1.50 per show.'],
  ['independent-service-disclaimer', 'Independent Service Disclaimer | EVLightShows.com', 'EVLightShows.com is an independent service and is not affiliated with, endorsed by, or sponsored by Tesla, Inc.'],
  ['refund-policy', 'Refund Policy | EVLightShows.com', 'Read the refund policy for EVLightShows.com digital light show purchases, including when refunds are available.'],
  ['copyright-music-upload-policy', 'Copyright and Music Upload Policy | EVLightShows.com', 'Read the copyright and music upload policy for EVLightShows.com. Users must own or have rights to the music they upload.'],
];
