...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    const { data: spent, error: spendErr } = await supabase.rpc("spend_credit", { uid: user.id });
    if (spendErr) {
